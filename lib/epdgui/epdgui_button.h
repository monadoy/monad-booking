...
class EPDGUI_Button : public EPDGUI_Base {
  public:
	...
	static const uint32_t STYLE_DEFAULT = STYLE_BORDERLESS | STYLE_ALIGN_CENTER;

  public:
	EPDGUI_Button(int16_t x, int16_t y, int16_t w, int16_t h);
	EPDGUI_Button(String label, int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color,
